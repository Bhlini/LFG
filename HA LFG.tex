...
\subsubsection{f-Struktur}
In dieser f-Struktur werden alle benötigten Attribut-Wert-Paare aufgelistet; im weiteren Verlauf werden nurmehr die für unsere Arbeit wichtigen Paare genannt.
\begin{singlespace}
\begin{avm}
