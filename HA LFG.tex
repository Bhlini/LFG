...
\textbf{Variante 2 - neu, mit zusätzlichen Beschränkungen}
\begin{singlespace}
\begin{tabular}{ l  l  c  c  c  c  c  c  c}
...
XP & $\rightarrow$ & \{ NP $\mid$ &  VP $\mid$ & PP \}* \\
   & $\qquad$ & \textsuperscript{($\uparrow$SUBJ) = $\downarrow$} &\textsuperscript{($\uparrow$XADJ) = $\downarrow$} & \textsuperscript{($\uparrow$ADJ) = $\downarrow$} \\
    & $\qquad$ & \textsuperscript{($\downarrow$CASE) = nom} & &  \\
    & $\qquad$ & \textsuperscript{$\mid$ ($\uparrow$OBJ) = $\downarrow$} & \textsuperscript{($\uparrow$ADJ) = $\downarrow$} &  \textsuperscript{($\uparrow$OBL\textsubscript{$\theta$}) = $\downarrow$} \\
       & $\qquad$ & \textsuperscript{$\mid$ ($\uparrow$OBL) = $\downarrow$} & \textsuperscript{($\uparrow$ADJ-GF) = $\downarrow$ $\mid$ ($\uparrow$ARG-GF) = $\downarrow$} &  \textsuperscript{$\uparrow$ = $\downarrow$} \\
         & $\qquad$ & \textsuperscript{$\mid$ ($\uparrow$ADJ) = $\downarrow$} & \textsuperscript{($\uparrow$ADJ-GF) = $\downarrow$ $\mid$ ($\uparrow$ARG-GF) = $\downarrow$} &  \textsuperscript{$\uparrow$ = $\downarrow$} \\
           & $\qquad$ & \textsuperscript{$\mid$ ($\uparrow$COMP) = $\downarrow$} & \textsuperscript{($\uparrow$ADJ-GF) = $\downarrow$ $\mid$ ($\uparrow$ARG-GF) = $\downarrow$} &  \textsuperscript{$\uparrow$ = $\downarrow$} \\
...
Anstatt zusätzliche (existenzielle?) Bedingungen /Forderungen zu den Syntaxregeln hinzuzufügen, könnte man stattdessen auch sogenannt Redundanz- bzw. Default-Regeln definieren, die über dem Lexikon operieren. (UNTERSCHIED? VOR- / NACHTEILE?)
