...
($\uparrow$XADJ CASE) = nom $\mid$ gen $\mid$ acc $\mid$ dat $\mid$ abl \\
...
($\uparrow$SUBJ ADJ CASE) = abl \textbf{???} \\
...
Partizip und Bezugswort stehen hierbei im Akkusativ: \\
($\uparrow$XCOMP CASE) = acc \\
($\uparrow$XCOMP SUBJ CASE) = acc \\
