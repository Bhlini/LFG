...
*aktiv passiv (Morphologie ergibt sich aus passiver Verbform im Lexikoneintrag (z.b. mittor statt mitto), aktive oder passive Diathese (z.b. relevant bei Deponentien) ergibt sich duch das vorhandene oder fehlende Merkmal ``passive'')
...
\begin{singlespace}
\begin{tabular}{ l  l  l  l  } 
\textbf{victis}: & $[1]$ \:  ($\uparrow$PRED) & = & `vincor$\langle$SUBJ, OBL\textsubscript{LOC}$\rangle$'\\
%$\qquad$ & $[2]$ \: $\neg$ ($\uparrow$SUBJ) & = & ((ADJ$\uparrow$)GF) \\
