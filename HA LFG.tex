...
S & $\rightarrow$ & V XP $\mid$ V \\
   & $\qquad$ & \textsuperscript{($\uparrow$OBJ) = $\downarrow$} &    $\qquad$ &\textsuperscript{$\uparrow$ = $\downarrow$} \\
...
XP & $\rightarrow$ & \{ NP, & $\qquad$ & VP, & $\qquad$ & PP \}* \\
   ...
   NP & $\rightarrow$ & N &  $\qquad$ & \{PP,    & $\qquad$ & VP\}* & $\mid$ & N \\
   & $\qquad$ & \textsuperscript{($\uparrow$ARG-GF) = $\downarrow$} & $\qquad$ & \textsuperscript{($\uparrow$ADJ-GF) = $\downarrow$ $\mid$ ($\uparrow$ARG-GF) = $\downarrow$} & $\qquad$ & \textsuperscript{($\uparrow$ADJ-GF) = $\downarrow$ $\mid$ ($\uparrow$ARG-GF) = $\downarrow$}\\
VP & $\rightarrow$ & V &  $\qquad$ & \{PP,    & $\qquad$ & NP\}* & $\mid$ & V \\
   & $\qquad$ & \textsuperscript{($\uparrow$ADJ-GF) = $\downarrow$ $\mid$ ($\uparrow$ARG-GF) = $\downarrow$} & $\qquad$ & \textsuperscript{($\uparrow$ADJ-GF) = $\downarrow$ $\mid$ ($\uparrow$ARG-GF) = $\downarrow$} & $\qquad$ & \textsuperscript{($\uparrow$ADJ-GF) = $\downarrow$ $\mid$ ($\uparrow$ARG-GF) = $\downarrow$}\\
PP & $\rightarrow$ & P &  $\qquad$ & \{VP,    & $\qquad$ & NP\}* & \\
   & $\qquad$ & \textsuperscript{($\uparrow$ADJ-GF) = $\downarrow$ $\mid$ ($\uparrow$ARG-GF) = $\downarrow$} & $\qquad$ & \textsuperscript{($\uparrow$ADJ-GF) = $\downarrow$ $\mid$ ($\uparrow$ARG-GF) = $\downarrow$} & $\qquad$ & \textsuperscript{($\uparrow$ADJ-GF) = $\downarrow$ $\mid$ ($\uparrow$ARG-GF) = $\downarrow$}\\
\end{tabular}\\
\newline
\newline
...
XP & $\rightarrow$ & \{ NP, & $\qquad$ & VP, & $\qquad$ & PP \}* \\
   & $\qquad$ & \textsuperscript{($\uparrow$ARG-GF) = $\downarrow$} &    $\qquad$ &\textsuperscript{($\uparrow$ADJ-GF) = $\downarrow$ $\mid$ ($\uparrow$ARG-GF) = $\downarrow$} & $\qquad$ & \textsuperscript{($\uparrow$ADJ-GF) = $\downarrow$ $\mid$ ($\uparrow$ARG-GF) = $\downarrow$} \\
   NP & $\rightarrow$ & PP N PP & $\mid$ & N & $\mid$ & N PP & $\mid$ & PP N \\
   & $\qquad$ & \textsuperscript{($\uparrow$OBJ) = $\downarrow$} &    $\qquad$ &\textsuperscript{$\uparrow$ = $\downarrow$} & $\qquad$ & \textsuperscript{$\downarrow$ $\in$ ($\uparrow$XADJ)} & $\qquad$ & \textsuperscript{($\uparrow$SUBJ) = $\downarrow$} \\
\end{tabular}\\
\end{singlespace}
